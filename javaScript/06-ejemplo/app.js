...
//***************************
    ...
    const frases = document.createElement('p');
    frases.textContent = item.phrases ? item.phrases.slice(0, 3).join('==> ') : 'Sin frases';
    bloqueTexto.appendChild(frases);

//*************************** 
    //ocupacion.textContent = item.phrases || 'sin Frases';
